...
export const QUESTS = {
  ...
  "Картограф": {
    ...
    chain: [
      ...
      { question: "Архив нужен всей деревне. Принеси 1 пустую карту — внесём последний безопасный путь в общий журнал.", requiredItem: "minecraft:map", requiredAmount: 1, rewardItem: "minecraft:book_and_quill", rewardAmount: 1, thanksLine: "Теперь у нас есть не только дороги, но и память о них.", upgrade: { tier: 5, label: "Архив карт" } }
    ],
